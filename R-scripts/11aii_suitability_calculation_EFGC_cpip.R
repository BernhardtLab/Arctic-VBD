...
EFGC.preds <- EFGC.nonarctic.quad.uni.raneff$BUGSoutput$sims.list$z.trait.mu.pred.pop ## Only get the population-level fit
...
# Save output
# write.csv(S.out, "data-processed/S.output.raw.EFGC.csv")
...
# ggsave("figures/S.CI.EFGC.png", plot.S, width = 10.3, height = 5.6)
...
# ggsave("figures/S.EFGC.png", plot.S, width = 10.3, height = 5.6)
...
# Save output
# write.csv(S.viz.out, "data-processed/SVizout.EFGC.csv")
...
# ggsave("figures/S.viz.EFGC.png", plot.S.viz, width = 10.3, height = 5.6)
...
# ggsave("figures/S.all.EFGC.png", plot.S.all, width = 10.3, height = 5.6)
...
SA <- SensitivityAnalysis_pd_EFGC(a.alldata.bri.uni.raneff, c.nonarctic.quad.uni,
                                  lf.arctic.quad.inf.raneff, PDR.arctic.bri.inf,
                                  EFGC.nonarctic.quad.uni.raneff, EV.arctic.quad.inf,
                                  pLA.arctic.quad.inf, MDR.arctic.bri.inf,
...
# ggsave("figures/SA.EFGC.png", plot.SA, width = 10.3, height = 5.6)


plot.everything <- ggarrange(plot.S, plot.S.viz, plot.SA, nrow = 3, align = "v", heights = c(2,1))
plot.everything

ggsave("figures/S.and.SA.EFGC.png", plot.everything, width = 10.3, height = 5.6)
...
EFGC.nonarctic.quad.uni.raneff$BUGSoutput$summary[1:5,]
...
# write.csv(S.output.lowerCI, "data-processed/S.output.lowerCI.EFGC.csv")
