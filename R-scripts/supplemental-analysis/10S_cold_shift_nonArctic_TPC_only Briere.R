...
MDR.nonarctic.params <- read_csv("data-processed/supplemental-analysis/briere-only/MDR.nonarctic.params.summary.csv")
...
MDR.arctic.params <- read_csv("data-processed/supplemental-analysis/briere-only/MDR.arctic.params.summary.csv")
...
##### PDR #####
# Read non-Arctic TPC parameters
# Briere model is already the best-fitting TPC for PDR
...
##### pLA #####
# Read non-Arctic TPC parameters
pLA.nonarctic.params <- read_csv("data-processed/supplemental-analysis/briere-only/pLA.nonarctic.params.summary.csv")
...
# Read Arctic TPC parameters
pLA.arctic.params <- read_csv("data-processed/supplemental-analysis/briere-only/pLA.arctic.params.summary.csv")
...
##### EV #####
# Read non-Arctic TPC parameters
EV.nonarctic.params <- read_csv("data-processed/supplemental-analysis/briere-only/EV.nonarctic.params.summary.csv")
...
# Read Arctic TPC parameters
EV.arctic.params <- read_csv("data-processed/supplemental-analysis/briere-only/EV.arctic.params.summary.csv")
...
##### lf #####
# Read non-Arctic TPC parameters
lf.nonarctic.params <- read_csv("data-processed/supplemental-analysis/briere-only/lf.nonarctic.params.summary.csv")
...
# Read Arctic TPC parameters
lf.arctic.params <- read_csv("data-processed/supplemental-analysis/briere-only/lf.arctic.params.summary.csv")
...
write_csv(params.list, "data-processed/supplemental-analysis/briere-only/tpc_parameters_diff_onlybriere.csv")
...
bc.iter.param <- data.frame(T0 = bc.nonarctic.bri.uni$BUGSoutput$sims.list$cf.T0,
                            Tm = bc.nonarctic.bri.uni$BUGSoutput$sims.list$cf.Tm,
                            q = bc.nonarctic.bri.uni$BUGSoutput$sims.list$cf.q
                            )
...
## Save output
write_csv(bc.params.fullposts, "data-processed/supplemental-analysis/briere-only/bc.arctic.params.fullposts.csv")
...
## Save output
write_csv(bc.params.summary, "data-processed/supplemental-analysis/briere-only/bc.arctic.params.summary.csv")
...
## Save output
write_csv(bc.arctic.preds, "data-processed/supplemental-analysis/briere-only/bc.arctic.predictions.fullposts.csv")
...
## Save output
write_csv(bc.predictions.summary, "data-processed/supplemental-analysis/briere-only/bc.arctic.predictions.summary.csv")
...
ggsave("figures/supplemental-analysis/briere-only/bc.arctic.bri.coldshift.png", plot.bc, width = 10.3, height = 5.6)
...
plot.bc.arctic.nonarctic <- bc.predictions.summary %>% 
  ggplot() +
  # Original
  geom_ribbon(data = df.bc.nonarctic.bri.uni, aes(x = temp, ymin = X2.5., ymax = X97.5.),
              fill = "#868686FF", alpha = 0.5) +
  geom_ribbon(aes(x = temperature, ymin = lowerCI, ymax = upperCI), 
              fill = "#009E73", alpha = 0.5) +
  
  geom_line(data = df.bc.nonarctic.bri.uni, aes(x = temp, y = X50.), 
...
ggsave("figures/supplemental-analysis/briere-onlybc.arctic.nonarctic.png", plot.bc.arctic.nonarctic, width = 10.3, height = 5.6)
