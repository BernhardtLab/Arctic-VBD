...
plot.S <- ggplot(data = S.out.upperCI) +
  ...
  labs(x = expression(paste("Temperature (", degree, "C)")), 
       y = "Suitability for transmission") +
  theme_bw() +
...
ggsave("figures/CSEE.suitability2.png", plot.suitability, width = 10, height = 6)
...
ggsave("figures/CSEE.sensitivity.analysis.png", plot.SA, width = 10, height = 5)
