...
##########
###### 2B. Fit MDR thermal responses for priors (Ae. sierrensis) ----
##########
...
##########
###### 2C. Fit gamma distributions to MDR prior thermal responses ----
##########
...
save(MDR.hypers, file = "R-scripts/R2jags-objects/MDRhypers.Rsave")


##########
###### 2D. Fit MDR thermal responses with data-informed priors (Ae. nigripes) ----
##########
...
##########
###### 2E. Plot all three TPCs in the same graph (for comparison) ----
##########
