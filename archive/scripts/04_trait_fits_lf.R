...
## Diagnostics
##### Examine output
lf.alldata.bri.uni$BUGSoutput$summary[1:38,]
...
## Plot data + fit
df.lf.alldata.bri.uni <- data.frame(lf.alldata.bri.uni$BUGSoutput$summary)[-(1:38),]
...
## Diagnostics
##### Examine output
lf.alldata.quad.uni$BUGSoutput$summary[1:38,]
...
## Plot data + fit
df.lf.alldata.quad.uni <- data.frame(lf.alldata.quad.uni$BUGSoutput$summary)[-(1:38),]
