...
##     Main text figure 4
##
## data-processed/supplemental-analysis/briere-only/S.predictions.fullposts.csv -
##     Full posterior distributions for suitability calculations
##
## data-processed/supplemental-analysis/briere-only/S.params.fullposts.csv - 
##     Full posterior distributions for suitability
##
## data-processed/supplemental-analysis/briere-only/S.predictions.summary.csv - 
##     Posterior summary of suitability across temperatures
##
## data-processed/supplemental-analysis/briere-only/S.params.summary.csv - 
##     Summary statistics of Tmin, Topt, and Tmax for suitability
## 
## ## data-processed/supplemental-analysis/briere-only/S.predictions.scaled.csv -
...
bc.preds <- read_csv("data-processed/supplemental-analysis/briere-only/bc.arctic.predictions.fullposts.csv")
...
bc.params.fullposts <- read.csv("data-processed/supplemental-analysis/briere-only/bc.arctic.params.fullposts.csv")
lf.params.fullposts <- read.csv("data-processed/supplemental-analysis/briere-only/lf.arctic.params.fullposts.csv")
PDR.params.fullposts <- read.csv("data-processed/PDR/PDR.arctic.params.fullposts.csv")
EFGC.params.fullposts <- read.csv("data-processed/supplemental-analysis/briere-only/EFGC.alldata.params.fullposts.csv")
EV.params.fullposts <- read.csv("data-processed/supplemental-analysis/briere-only/EV.arctic.params.fullposts.csv")
pLA.params.fullposts <- read.csv("data-processed/supplemental-analysis/briere-only/pLA.arctic.params.fullposts.csv")
MDR.params.fullposts <- read.csv("data-processed/supplemental-analysis/briere-only/MDR.arctic.params.fullposts.csv")
...
# Save output
write.csv(S.preds.fullposts, "data-processed/supplemental-analysis/briere-only/S.predictions.fullposts.csv")
...
write.csv(S.params.fullposts, "data-processed/supplemental-analysis/briere-only/S.params.fullposts.csv")
...
write.csv(S.out.median, "data-processed/supplemental-analysis/briere-only/S.predictions.summary.csv")
...
ggsave("figures/supplemental-analysis/briere-only/suitability.png", plot.S, width = 10.3, height = 5.6)
...
# Save output
write.csv(S.params.summary, "data-processed/supplemental-analysis/briere-only/S.params.summary.csv")
...
SA <- SensitivityAnalysis_pd_bri(a.preds, bc.preds, lf.preds, PDR.preds, 
...
ggsave("figures/supplemental-analysis/briere-only/sensitivity.analysis.png", plot.SA, width = 10, height = 5)
...
write.csv(S.out.scaled, "data-processed/supplemental-analysis/briere-only/S.predictions.scaled.csv")
